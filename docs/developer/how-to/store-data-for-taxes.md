---
id: store-data-for-taxes
title: Store data for a tax calculation service
sidebar_label: Store data for taxes
---

After you integrate a tax calculation service with Commerce Cloud, you can configure nexus locations. Nexus locations are added to carts to calculate the correct tax rate.
