---
id: create-short-order-ids
title: Create short order IDs
sidebar_label: Create short order IDs
---
...
1. Create a new field for the flow by doing the following:
    ...
    1. Click **New Field**.
    1. In the **Field:** >> **Field type** field, select one of the following options:
            - **Boolean**
            - **Float**
            - **Integer**
            - **String**
...
- [Integratoins API](../../api/advanced/integrations/index.md)
