---
id: create-a-blog-resource
title: Create a blog resource
sidebar_label: Create a blog resource
---

Add custom data to create and manage blog.

If you want to use a single platform for multiple solutions, Commerce Cloud API gives you the ability to use custom data to create a blog. You can manage your content with some light configuration.
...
You can use the Commerce Cloud API to manage your content. You would use custom Flows for that. If you have a more robust Content Management System (CMS) in mind, we recommend plugging in a third-party CMS tool, such as Contentful.
...
Using the Commerce Cloud API, fetch the blog Flow which now contains the blog post created previously.
