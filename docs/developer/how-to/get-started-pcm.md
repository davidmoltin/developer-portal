---
id: get-started-pcm
title: Get Started with Product Content Management
sidebar_label: Get Started with PCM
---
...
Create a store separate from your production store where you can work with the Product Content Management APIs. Sign in to the store to get your client ID and secret.
...
```bash
curl -X POST https://api.moltin.com/pcm/hierarchies/:hierarchyId/nodes \
     -H "Authorization: Bearer <your_access_token>" \
     -d $'{
        "data": {
            "type": "node",
...
Now letʼs create two products. Most of the attributes should be familiar to you, but if not, see [the `product_attributes` object](../../api/pcm/products/index.md#the-product_attributes-object).
...
```bash
curl -X POST https://api.moltin.com/pcm/hierarchies/:hierarchyId/nodes/:nodeIdforElectricRanges/relationships/products \
     -H "Authorization: Bearer <your_access_token>" \
     -d $'{
        "data": [
            {
...
```bash
curl -X POST https://api.moltin.com/pcm/hierarchies/:hierarchy Id/nodes/:nodeIdforGasRanges/relationships/products \
     -H "Authorization: Bearer <your_access_token>" \
     -d $'{
        "data": [
            {
...
```bash
curl -X POST https://api.moltin.com/pcm/pricebooks/:pricebookId/prices \
     -H "Authorization: Bearer <your_access_token>" \
     -H "Content-Type: application/json" \
     -d $'{
        "data": {
...
```bash
curl -X POST https://api.moltin.com/pcm/catalogs/:catalogId/releases \
     -H "Authorization: Bearer <your_access_token>" \
     -H "Content-Type: application/json" \
```
...
```bash
curl -X GET https://api.moltin.com/pcm/catalogs/:catalogId/releases/:releaseId  \
     -H "Authorization: Bearer <your_access_token>" \
```
